...
func AliyunTranscodingMedia(data *callback.AliyunMediaCallback[callback.AliyunTranscodingMediaStruct]) (results interface{}, err error) {
	// 从数据库查询任务
	taskInfo := new(sundry.TranscodingTask)
