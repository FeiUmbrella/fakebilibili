...
func GetArticleContributionListResponse(l *article.ArticlesContributionList) GetArticleContributionListByUserResponseList {
	...
	for _, v := range *l {
		...
		response = append(response, GetArticleContributionListByUserResponseStruct{
			...
			IsComments:     conversion.Int82Bool(v.IsComments),
			Heat:           v.Heat,
...
func GetArticleClassificationListResponse(cl *article.ClassificationsList) ArticleClassificationInfoList {
...
func GetArticleTotalInfoResponse(cl *article.ClassificationsList, articleNum *int64, clNum int64) interface{} {
...
func GetArticleContributionByIDResponse(vc *article.ArticlesContribution) GetArticleContributionByIDResponseStruct {
	...
	response := GetArticleContributionByIDResponseStruct{
		...
		Label:          label,
		Content:        vc.Content,
		IsComments:     conversion.Int82Bool(vc.IsComments),
		Heat:           vc.Heat,
